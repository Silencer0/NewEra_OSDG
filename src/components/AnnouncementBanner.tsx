...
export default function AnnouncementBanner() {
  ...
  return (
    ...
    >
      <a
        href="https://forms.cloud.microsoft/r/XP6n8nR3ny"
        target="_blank"
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <p className="text-sm md:text-base text-white font-oxanium font-semibold tracking-wide">
              <span className="text-green-400">I am recruiting:</span> <span className="text-gray-300 font-normal">Apply here.</span>
            </p>
          </div>
